...
class RepaymentHelper extends SmyHelper
{
    ...
    public function searchPlans(Request $request)
    {
        ...
        try {
            $response = $this->manage->repaymentsPlans($this->addHeaderPostField($request, $postField));
            /* $response = [
                 [
                     'orderNo' => '12345',
    ...
    public function history(Request $request)
    {
        ...
        try {
            $response = $this->manage->repaymentRecords($this->addHeaderPostField($request, $postField));
            /*$response = [
    ...
    public function getResults(Request $request)
    {
        ...
        try {
            $response = $this->manage->repaymentResults($this->addHeaderPostField($request, $postField));
